...
?>
    ...
    <div class="container-fluid">
                ...
                <div class="col-auto col-md-3 col-xl-2 px-sm-2 px-0 bg-dark">
                    <div class="d-flex flex-column align-items-center align-items-sm-start px-3 pt-2 text-white min-vh-100">
                        ...
                        <ul class="nav nav-pills flex-column mb-sm-auto mb-0 align-items-center align-items-sm-start" id="menu">
                            <li class="nav-item">
                                <a href="../sg-sst.php" class="nav-link align-middle px-0 link-danger">
            ...
            <h3 class="display-3 text-dark fw-bold titulo-items">Estandar 7 - Items</h3>
            ...
            <div class="btns-cre-su">
                <tr>
                    ...
                    <td>
                        ...
                        <a href="crearDocumento7.php" class="btn btn-warning">Crear Documento</a>
                        |
            ...
            <div class="btns-cre-su">
                <tr>
                    ...
                    <td>
                        ...
                        <a href="crearMatrices7.php" class="btn btn-warning">Crear Matriz</a>
                        |
