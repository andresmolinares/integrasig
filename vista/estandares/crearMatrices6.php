...
<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/5.15.3/css/all.min.css" />
    ...
    <div class="container-fluid">
                ...
                <div class="col-auto col-md-3 col-xl-2 px-sm-2 px-0 bg-dark">
                    <div class="d-flex flex-column align-items-center align-items-sm-start px-3 pt-2 text-white min-vh-100">
                        ...
                        <ul class="nav nav-pills flex-column mb-sm-auto mb-0 align-items-center align-items-sm-start" id="menu">
                            <li class="nav-item">
                                <a href="estandar-6items.php" class="nav-link align-middle px-0 link-danger">
            ...
            <h3 class="display-4 text-dark fw-bold estandar-tittulo">Crear Matrices</h3>
            <hr>
            <div class="formu">
...
<form>
     ...
     <div class="mb-3">
         ...
         <select class="form-select" aria-label="Disabled select example" disabled>
                                 ...
                                 <option selected>Estandar - 6</option>
     ...
     <a href="./estandar-6items.php"  class="btn btn-primary boton2">Atras</a>
