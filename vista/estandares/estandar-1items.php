                    ...
                    <div class="btns-cre-su">
                        <tr>
                            ...
                            <td>
                                ...
                                <!--final alerta subir documentos-->
                            </td>

                        </tr>
                    </div>
                    <!-- comienzo tabla documentos estandar 1-->
                    ...
                    <div class="btns-cre-su">
                        <tr>
                            ...
                            <td>
                                ...
                                <!--final alerta subir matriz-->

                            </td>

                        </tr>
                    </div>
                    <!-- comienzo tabla matrices estandar 1-->
                    <table class="table table-striped table-hover">
                        <thead class="bg-dark text-light">
                            <tr>
                                <th>Item</th>
