...
?>
    ...
    <head>
        ...
        <title>Matriz de rendicion de cuentas</title>
        ...
        <div class="container-fluid">
            <div class="row flex-nowrap">
                ...
                <div class="col py-3" id="content">
                    <h3 class="display-4 text-dark fw-bold estandar-tittulo">Matriz de rendicion de cuentas</h3>
                    <hr>


                    <!--formulario rendicion de cuentas-->
                    <div class="formu">
                        ...
                        <form>
                            ...
                            <div class="mb-3">
                                <label for="" class="form-label">A quien:</label>
                                <input type="text" class="form-control" id="a_quien">
                            </div>

                            <div class="mb-3">
                                <label for="" class="form-label">Como:</label>
                                <textarea id="como" class="form-control"></textarea>
                            </div>

                            <div class="mb-3">
                                <label for="" class="form-label">Frecuencia de reporte:</label>
                                <select class="form-select" id="frecuencia_reporte">
                        ...
                        <!--ifinal formularioo rendicion cuentas-->
