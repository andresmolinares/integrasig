...
?>
    ...
    <body>
        ...
        <div class="container-fluid">
                ...
                <div class="col-auto col-md-3 col-xl-2 px-sm-2 px-0 bg-dark">
                    <div class="d-flex flex-column align-items-center align-items-sm-start px-3 pt-2 text-white min-vh-100">
                        ...
                        <ul class="nav nav-pills flex-column mb-sm-auto mb-0 align-items-center align-items-sm-start" id="menu">
                            <li class="nav-item">
                                <a href="../../crearMatrices.php" class="nav-link align-middle px-0 link-danger">
            ...
            <h3 class="display-4 text-dark fw-bold estandar-tittulo">Matriz de Responsabilidad</h3>
            <hr>


            <div class="formu">

            <!-- comienzo formulario matriz responsabilidad-->
                   ...
                   <form>
                        ...
                        <div class="mb-3">
                            <label for="" class="form-label">Quien asume el rol :</label>
                            <input type="text" class="form-control" id="">
                        </div>
                        ...
                        <div class="mb-3">
                            <label for="" class="form-label">Responsabilidades :</label>
                        ...
                        <!-- final formulario matriz responsabilidad-->
